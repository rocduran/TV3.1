...
public class EnquestaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Passa al següent usuari", Snackbar.LENGTH_LONG)
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(R.string.seccio1);
                case 1:
                    return getString(R.string.seccio2);
                case 2:
                    return getString(R.string.seccio3);
            }
            return null;
        }
    }
