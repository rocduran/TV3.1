 ...
 * more than a {@link EnquestaDetailFragment}.
 */
public class EnquestaDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(EnquestaDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(EnquestaDetailFragment.ARG_ITEM_ID));
            EnquestaDetailFragment fragment = new EnquestaDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.enquesta_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, EnquestaListActivity.class));
            return true;
        }
