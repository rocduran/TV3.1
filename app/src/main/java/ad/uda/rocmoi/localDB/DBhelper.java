...
public class DBhelper  extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //TODO crear les taules que farem servir per guardar totes les dades
        //jo veig una taula enquestes (continuan amb la idea del ultim commit
        //i una taula valoracions(del estil de la que tenim al server)
